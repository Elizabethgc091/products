      ...
      <div className="d-flex">
        ...
        <div className="p-2">
          <select className="select-form" aria-label="Default select example">
            <option selected>Cargas masivas</option>
          </select>
        </div>
        <div className="p-2">
          <button type="button" className="btn-cargar" onClick={createProduct}>
            {" "}
            + Cargar producto
          </button>
        </div>
      ...
      <div className="d-flex align-items-center">
        ...
        <div className="p-2">
          <select className="select-gst" aria-label="Default select example">
            <option selected>Gestionar columnas</option>
          </select>
        </div>
      ...
      <table className="table fs-5">
        <thead className="table-bkg">
          <tr className="color-purple">
            ...
            <th scope="col">
              SKU SIMPLE <img src={chevron} alt="expand" />
            </th>
            <th scope="col">
              SKU <img src={chevron} alt="expand" />
            </th>
            <th scope="col">
              UPC <img src={chevron} alt="expand" />
            </th>
            <th scope="col">
              PRECIO <img src={chevron} alt="expand" />
            </th>
            <th scope="col">
              FECHA DE CARGA <img src={chevron} alt="expand" />
            </th>
            <th scope="col">
              ESTADO <img src={chevron} alt="expand" />
            </th>
            <th scope="col"></th>
          </tr>
        </thead>
              ...
              <tr className="fs-5" key={key}>
                ...
                <td>
                  {product.enable === "true" ? (
                    ...
                    <span className="badge text-bg-warning">Publicado</span>
                  )}
                </td>
                <td>
                    ...
                    <ul className="dropdown-menu">
                      ...
                      <li>
                        <a
                          ...
                          href="#"
                          onClick={() => deleteItem(product.upc)}
                        >
                          <i className="bi bi-x-lg"></i> Eliminar Producto
                        </a>
                      </li>
                    </ul>
                  </div>
